...
\begin{itemize}
    ...
    \item \textbf{Performance Benchmarking:} A measured $10.7\times$ wall-clock speedup over a single-layer PINN and $389\times$ over a four-layer deep PINN on the 1-D Poisson benchmark, demonstrating suitability for real-time edge computing and digital twins.
\end{itemize}
